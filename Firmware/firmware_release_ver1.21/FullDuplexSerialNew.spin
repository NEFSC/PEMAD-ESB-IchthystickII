...
''*  (C) 2006 Parallax, Inc.         *
''************************************
''version 1.1: Original release by Parallax..
''
''version 1.2:
''      Modified Transmit and Receive Buffers so that they can hold 80 characters
'' instead of 15.
''      Joseph Godlewski
...
' byte  tx_buffer[16]  
  byte  rx_buffer[81]           'transmit and receive buffers
  byte  tx_buffer[81]  
